		...
		<div class="col-md-12">
			<div class="debate-item anticorrupcao">
				<div class="text-center">
					<a href="<?php echo site_url("/anticorrupcao"); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logos/logo-anticorrupcao-w.png" class="img-adptive mt-lg" alt="Medidas Anticorrupção"></a>
				</div>
